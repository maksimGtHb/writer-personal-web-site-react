...
const StrengthsPage = () => {
    ...
    return (
        ...
        <div className = "strengths-image-container">
            ...
            <img src = "/img1.jpg" alt="img1" className="strengths-image"/>
            </a>
            ...
            <figure>
            <a href="http://google.com">
            <img src = "/img2.jpg" alt="img2" className="strengths-image"/>
            </a>
        ...
        <figure>
            <a href="http://google.com">
            <img src = "/img3.jpg" alt="img3" className = "strengths-image-big"/>
            </a>
        ...
        <div className = "strengths-image-container">
             ...
             <figure>
             <a href="http://google.com"> <img src = "/img4.jpg" alt="img4" className="strengths-image"/></a>
             <figcaption>Lake Bled</figcaption>
             </figure>
            
            <figure>
                <a href = "http://google.com">  <img src = "/img5.jpg" alt="img5" className="strengths-image"/></a>
        ...
        <div class = "whyThisProfession" >
            <img src = "/whyThisProfessionBackground.jpg" alt="whyThisProfessionImg"></img>
